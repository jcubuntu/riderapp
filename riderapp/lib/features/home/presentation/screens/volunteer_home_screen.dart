...
class _VolunteerHomeScreenState extends ConsumerState<VolunteerHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (dashboardState is DashboardStatsLoaded) {
      pendingIncidents = dashboardState.stats.incidents.pending +
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('home.volunteer.title'.tr()),
        actions: [
          IconButton(
                ...
                children: [
                  Expanded(
                    child: _buildStatCard(
                      ...
                      label: 'home.volunteer.assignedIncidents'.tr(),
