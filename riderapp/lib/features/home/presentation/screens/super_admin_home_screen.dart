...
class _SuperAdminHomeScreenState extends ConsumerState<SuperAdminHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (userSummaryState is UserSummaryLoaded) {
      ...
      // Note: totalAdmins would come from a separate admin count if available
      // For now, we'll use a placeholder or could add to user summary
    }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('home.superAdmin.title'.tr()),
        actions: [
          IconButton(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: _buildStatCard(
                      ...
                      label: 'home.superAdmin.totalAdmins'.tr(),
                ...
                children: [
                  Expanded(
                    child: _buildStatCard(
                      ...
                      value: _formatNumber(pendingApprovals),
              ...
              _buildActionTile(
                context,
                icon: Icons.admin_panel_settings,
                title: 'home.superAdmin.manageAdmins'.tr(),
                subtitle: 'home.superAdmin.manageAdminsDesc'.tr(),
                color: AppColors.error,
                onTap: () {
                  // TODO: Navigate to admin management
                },
              ...
              _buildActionTile(
                context,
                icon: Icons.settings,
                title: 'home.superAdmin.systemConfig'.tr(),
                subtitle: 'home.superAdmin.systemConfigDesc'.tr(),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            ...
            label: 'home.superAdmin.title'.tr(),
          ),
          BottomNavigationBarItem(
          ...
          BottomNavigationBarItem(
            ...
            label: 'home.superAdmin.system'.tr(),
          ),
          BottomNavigationBarItem(
